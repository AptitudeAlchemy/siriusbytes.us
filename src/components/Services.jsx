...
function Services() {
  ...
  return (
    <section
      id="our-services"
      className="Services container d-flex justify-content-start align-items-center py-5 flex-column"
